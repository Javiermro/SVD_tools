...
StrainModesFolder='/CIMNE/toolsSVD/Offline/Modes/'; 
offlineFolder='/CIMNE/toolsSVD/Offline/'; cd(offlineFolder);
...
nE_max = 9; % number of elastic snapshots (Maximo) JLM
nPos = 90; % number of Inelastic snapshots (DEBE COINCIDIR CON STEP 02)
nameEnergySnap = ['Phi_tot'] ; %Phi_ela  Phi_vol  Phi_dev  Phi_pla  Phi_tot% name of Snapshot energy in the folder
nameExtensionW = ['RVE_Hole_05_nPos' num2str(nPos)]; % Directory of Modes (debe coincidir con Step03_01
load('C:/CIMNE/Codes/MultiScale_SantaFe/Examples/RVE_Hole_05/DomainPointers.mat'); % Pointer for Domain Decomposition 
snpFolder=[ ...
